...
const UserLogin = () => {
    ...
    return (
       ...
       <div>
        <Link to="/captain-login" className="bg-[#0c44059d] flex items-center justify-center text-white font-semibold mb-5 rounded px-4 py-2  w-full text-lg placeholder:text-base">
